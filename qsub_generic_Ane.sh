...
while getopts "t:s:e:a:r:z:o:m:q:c:p:g:i:n:u:h:d:f:j:" opt; do
    case $opt in
        t) tool="$OPTARG";;
        s) sub="$OPTARG";;
        e) ses="$OPTARG";;
...
export subjbids="$sub"
export path2subderivatives="${analydir}/derivatives/${tool}/analysis-${analysis}/${subjbids}/ses-${ses}"
export path2config="${analydir}/derivatives/${tool}/analysis-${analysis}/config.json"

printf "\n\n [qsub_generic.sh] It will use basedir:${analydir} and tool:$tool \n\n"
